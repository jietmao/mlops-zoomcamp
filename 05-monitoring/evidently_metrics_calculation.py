...
def calculate_metrics_postgresql(curr, i):
    ...
    fare_amount_mean = result['metrics'][1]['result']['current']['value']
    ...
    curr.execute(
        "insert into dummy_metrics(timestamp, fare_amount_mean, prediction_drift, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s, %s)",
        (begin + datetime.timedelta(i), fare_amount_mean, prediction_drift, num_drifted_columns, share_missing_values)
    )


# @flow(name='batch_monitoring_backfill')
